...
class calc(QMainWindow):
    ...
    def main(self):
        ...
        self.dis.setFont(QFont('Cablri',20))
        self.dis.setObjectName('disp')
        self.styleSheet = ('''
QPushButton {
...
''')
        ...
        self.dis.setStyleSheet(self.styleSheet)
        f = QtGui.QFont()
        f.setPixelSize(20)
        f.setBold(True)
        f.setWeight(705)
        ...
        self.box4.setStyleSheet(self.styleSheet)
